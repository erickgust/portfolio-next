      ...
      <main className='mx-auto max-w-screen-lg border-x border-[#1B1B1B]'>
        ...
        <section className='relative space-y-36 py-40 sm:space-y-44'>
          ...
          <Project
            ...
            leftContent={
              <p>
                ...
                more in-depth by building a contact management feature that lets
                you create, edit, delete, and view contacts, as well as organize
                them by categories.
              </p>
            }
            rightContent={
              <p>
                I also had the opportunity to develop a REST API in Node.js with
                Express, which connects to a Docker environment running
                PostgreSQL.
              </p>
            }
            actions={
          ...
          <Project
            ...
            leftContent={
              <p>
                TMDB Movies is a project that lets you browse a list of trending
                movies, filtered by various genres. By selecting a movie, you
                can view details such as rating, synopsis, cast, genres, and
                certification.
              </p>
            }
            rightContent={
              <p>
                This project was built in TypeScript and React to explore React
                Query features combined with React Router. It also uses the Zod
                library to ensure type safety for data fetched from the TMDB
                API.
              </p>
            }
            actions={
