...
export function ProjectLink({ href, type, children }: ProjectLinkProps) {
  ...
  return (
    <a
      ...
      className='group relative inline-flex items-center justify-center gap-2.5 overflow-hidden rounded-full border border-[--color] px-4 py-2 text-sm leading-none text-[--color]'
    >
